...
class StaticTrain(Dataset):
    def __init__(self,
        ...
        '''dataset_list.append( 'PASCAL-S')
        #img_dir_1 = os.path.join("/home/cs22-liwy/170-lwy/DATA/datasets/imgs/pascal")
        #mask_dir_1 = os.path.join("/home/cs22-liwy/170-lwy/DATA/datasets/masks/pascal")
        img_dir_1 ="../DATA/datasets/imgs/pascal/"
        mask_dir_1 ="../DATA/datasets/masks/pascal/"

        print("img_dir_1:", img_dir_1)

        img_list_1 = sorted(glob(os.path.join(img_dir_1, '*.jpg'))) + \
                     sorted(glob(os.path.join(img_dir_1, '*.png')))
        print("img:", len(img_list_1))
        mask_list_1 = sorted(glob(os.path.join(mask_dir_1, '*.png')))
        print("mask:", len(mask_list_1))

        self.img_list.extend(img_list_1)
        self.mask_list.extend(mask_list_1)
        ...
        dataset_list.append('PASCAL-S')
        print(
            f'\t {len(img_list_1)} imgs are used for PreTrain. They are from PASCAL-S.'
        )'''
...
class MOSE_Train(VOSTrain):
    def __init__(self,
        ...
        super(MOSE_Train, self).__init__(image_root,
                                              label_root,
                                              imglistdic,
                                              transform,
                                              rgb,
