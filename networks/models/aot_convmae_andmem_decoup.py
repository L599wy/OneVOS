...
from networks.cores.convmae.convmae_uni_hybrid_attention import build_onevos_convmae


class OneVOS_CONVMAE(nn.Module):
    def __init__(self, cfg, decoder='fpn_vitshortcut_deconv_convmae'):
        ...
        self.backbone=build_onevos_convmae(cfg)
